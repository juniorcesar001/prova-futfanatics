        ...
        <div class="card card-body mb-3">
            <form action="inserir.php" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="datetime-local" name="dateTime" value="2011-08-19T13:45:00" id="datetime-input">
                    </div>
                </div>
        ...
        <div class="col-sm-10">
            <div class="form-check">
                ...
                <div class="badge bg-success">
                    <?= $task->data_entrega == "0000-00-00 00:00:00" ? "Sem Prazo" : $task->data_entrega; ?>
                </div>
            </div>
        </div>
        <div class="col-sm-2">
